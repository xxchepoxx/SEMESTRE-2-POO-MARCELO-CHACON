...
print("UNIDAD II")
print("Tarea semana 7 - Gestión de Eventos y Manejo de Excepciones")
print("Gestor de Tareas con Interfaz Gráfica Tkinter")
# ======================================================================================================================
# Tarea semana 7 - Gestión de Eventos
# ======================================================================================================================
...
class Tarea:
    ...
    def to_dict(self):
        """Convierte la tarea a diccionario para persistencia."""
        return {
            "texto": self._texto,
    ...
    def from_dict(cls, d):
        ...
        return cls(d.get("texto"), d.get("completada", False))
